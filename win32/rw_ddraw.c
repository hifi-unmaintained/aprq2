...
Com_Printf ( "Initializing DirectDraw\n");
	...
	*/
	...
	{
		Com_Printf ( "*** DirectDrawCreate == NULL ***\n" );
		goto fail;
	}
	...
	*/
	else if ( ( sw_mode->integer == 0 ) && sw_allow_modex->integer )
	{
		Com_Printf ( "failed\n" );
